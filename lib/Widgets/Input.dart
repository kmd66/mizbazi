...
class AppInput extends StatelessWidget {
  const AppInput( {required this.text,this.maxLength, this.counterText,  this.onChanged, this.keyboardType, this.controller});
  final String text;
  ...
  Widget build(BuildContext context) {
    return  Directionality(textDirection:keyboardType == TextInputType.number? TextDirection.ltr:TextDirection.rtl,
        child:TextField(
